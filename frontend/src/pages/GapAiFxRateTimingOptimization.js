...
// v0 scaffold for: No AI FX rate-timing optimization
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-ai-fx-rate-timing-optimization/run.

export default function AiFxRateTimingOptimizationPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-ai-fx-rate-timing-optimization/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No AI FX rate-timing optimization</h1>
