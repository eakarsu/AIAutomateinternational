...
// v0 scaffold for: No bulk transfer operations
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-bulk-transfer-operations/run.

export default function BulkTransferOperationsPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-bulk-transfer-operations/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No bulk transfer operations</h1>
