...
// v0 scaffold for: No mobile remitter app
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-mobile-remitter-app/run.

export default function MobileRemitterAppPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-mobile-remitter-app/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No mobile remitter app</h1>
