...
// v0 scaffold for: No native blockchain settlement option
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-native-blockchain-settlement-option/run.

export default function NativeBlockchainSettlementOptionPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-native-blockchain-settlement-option/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No native blockchain settlement option</h1>
