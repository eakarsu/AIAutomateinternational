...
// v0 scaffold for: SWIFT, Wise, Remitly, and regulatory data-feed connectors
// Generated by batch_00 audit. Wire to real API; v0 calls /api/cf-swift-wise-remitly-regulatory-data/run.

export default function SwiftWiseRemitlyRegulatoryDataPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-swift-wise-remitly-regulatory-data/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>SWIFT, Wise, Remitly, and regulatory data-feed connectors</h1>
